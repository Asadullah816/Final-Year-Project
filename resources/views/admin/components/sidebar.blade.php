     ...
     <div class="sidebar pe-4 pb-3">
         <nav class="navbar bg-secondary navbar-dark">
             ...
             <div class="navbar-nav w-100">
                 ...
                 <a href="{{ route('dashboard') }}" class="{{ activeTab('dashboard') }} nav-item nav-link "><i
                         class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                 <a href="{{ route('qualification') }}" class="{{ activeTab('qualification') }}  nav-item nav-link"><i
                 ...
                 <a href="{{ route('applications') }}" class="{{ activeTab('applications') }} nav-item nav-link"><i
